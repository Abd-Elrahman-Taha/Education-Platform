...
import {
  Plus, Send, LogIn, UserPlus, Sparkles, ShieldCheck,
  Inbox, Mail, MailOpen, Clock, CheckCircle2, AlertCircle, RefreshCw, ChevronDown, ChevronUp,
  ArrowDownLeft, ArrowUpRight, MessageCircle, HelpCircle, Bell,
} from 'lucide-react';
...
export const CommunityView: React.FC<CommunityViewProps> = ({ onOpenAuthModal }) => {
      ...
      <div className="container fade-in-up" style={{ padding: '3rem 1.5rem 6rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem', maxWidth: '900px', margin: '0 auto 3rem' }}>
          <div className="glass-card" style={{ padding: '1.75rem', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0, lineHeight: 1.6 }}>أرسل سؤالك أو مشكلتك مباشرة للإدارة واحصل على توجيه دقيق.</p>
          </div>
          <div className="glass-card" style={{ padding: '1.75rem', textAlign: 'center' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '14px', margin: '0 auto 1rem', background: 'rgba(8,145,178,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <ShieldCheck size={24} color="#10B981" />
            </div>
            <h3 style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-bright)', marginBottom: '0.4rem' }}>إجابات رسمية ومتابعة مستمرة</h3>
            <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0, lineHeight: 1.6 }}>متابعة سريعة من فريق الإدارة والمعلم لحل أي استفسار أكاديمي أو تقني.</p>
          </div>
          <div className="glass-card" style={{ padding: '1.75rem', textAlign: 'center' }}>
            <div style={{ width: '48px', height: '48px', borderRadius: '14px', margin: '0 auto 1rem', background: 'rgba(8,145,178,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Bell size={24} color="#F59E0B" />
            </div>
            <h3 style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-bright)', marginBottom: '0.4rem' }}>إشعارات بالردود فوراً</h3>
            <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0, lineHeight: 1.6 }}>يصلك إشعار فوري عند قيام المسؤولين بالرد على أي رسالة مرسلة من قبلك.</p>
          </div>
        </div>
        ...
        <div className="glass-card" style={{
          ...
          <MessageCircle size={36} color="var(--primary-light)" style={{ marginBottom: '1rem' }} />
          <h2 style={{ fontSize: '1.35rem', fontWeight: 800, color: 'var(--text-bright)', marginBottom: '0.5rem' }}>
            سجّل دخولك للوصول إلى صندوق الرسائل
          </h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1.75rem', lineHeight: 1.6 }}>
            سجّل الدخول للتواصل مع الإدارة ومتابعة استفساراتك وردود المعلم.
          </p>
  ...
  return (
    <div className="container fade-in-up" style={{ padding: '2.5rem 1.5rem 5rem 1.5rem' }}>
      {/* Top Banner */}
      <div className="glass-card" style={{ padding: '1.75rem 2rem', marginBottom: '1.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.2rem', display: 'flex', alignItems: 'center', gap: '0.6rem', color: 'var(--text-bright)' }}>
            <MessageCircle size={24} color="var(--primary-light)" /> الرسائل مع الإدارة (الواردة والصادرة)
          </h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', margin: 0 }}>
            تواصل مباشر وحصري بين الطالب وإدارة المنصة لمتابعة الاستفسارات والردود
          </p>
        </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: استفسار عن تفعيل كورس / مشكلة في المحاضرة / سؤال أكاديمي..."
                  style={{ width: '100%' }}
                  value={newSubject}
